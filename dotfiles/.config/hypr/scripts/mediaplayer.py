...
class PlayerManager:
    def __init__(self, selected_player=None, excluded_player=[], status=False):
        self.manager = Playerctl.PlayerManager()
        self.loop = GLib.MainLoop()
        self.only_status = status
    ...
    def on_metadata_changed(self, player, metadata, _=None):
        ...
        if track_info and self.only_status:
            if player.props.status == "Playing":
                msg = "Playing"
            else:
                msg = "Paused"
...
def main():
    ...
    player = PlayerManager(arguments.player, arguments.exclude, arguments.status)
    player.run()
